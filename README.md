...
```sh
npm install -g @leancode/contractsgenerator-typescript
...
```sh
npm install -D @leancode/contractsgenerator-typescript
...
```sh
npx -p @leancode/contractsgenerator-typescript ts-generator
```
...
/**
 * @type {import("@leancode/contractsgenerator-typescript").ContractsGeneratorConfiguration}
 */
module.exports = {
    typesFile: {

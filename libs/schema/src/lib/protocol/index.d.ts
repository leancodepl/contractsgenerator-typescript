...
export namespace leancode {
  ...
  namespace contracts {
    ...
    namespace ValueRef {
      ...
      class FloatingPointNumber implements IFloatingPointNumber {
        ...
        public static decode(
          ...
          length?: number,
        ): leancode.contracts.ValueRef.FloatingPointNumber
      ...
      class Boolean implements IBoolean {
        ...
        public static decode(
          reader: $protobuf.Reader | Uint8Array,
          length?: number,
        ): leancode.contracts.ValueRef.Boolean
    ...
    class TypeRef implements ITypeRef {
       ...
       */
      public static toObject(
        message: leancode.contracts.TypeRef,
        options?: $protobuf.IConversionOptions,
      ): { [k: string]: any }
    ...
    namespace TypeRef {
      ...
      class Internal implements IInternal {
        ...
        public static decode(
          reader: $protobuf.Reader | Uint8Array,
          length?: number,
        ): leancode.contracts.TypeRef.Internal
    ...
    class NotificationTypeRef implements INotificationTypeRef {
      ...
      public static decode(
        reader: $protobuf.Reader | Uint8Array,
        length?: number,
      ): leancode.contracts.NotificationTypeRef
    ...
    namespace AttributeArgument {
      ...
      class Positional implements IPositional {
        ...
        public static decode(
          reader: $protobuf.Reader | Uint8Array,
          length?: number,
        ): leancode.contracts.AttributeArgument.Positional
      ...
      class Named implements INamed {
        ...
        public static decode(
          reader: $protobuf.Reader | Uint8Array,
          length?: number,
        ): leancode.contracts.AttributeArgument.Named
    ...
    namespace ErrorCode {
      ...
      class Single implements ISingle {
        ...
        public static decode(
          reader: $protobuf.Reader | Uint8Array,
          length?: number,
        ): leancode.contracts.ErrorCode.Single
    ...
    namespace Statement {
      ...
      class Command implements ICommand {
        ...
        public static decode(
          reader: $protobuf.Reader | Uint8Array,
          length?: number,
        ): leancode.contracts.Statement.Command
      ...
      class Operation implements IOperation {
        ...
        public static decode(
          reader: $protobuf.Reader | Uint8Array,
          length?: number,
        ): leancode.contracts.Statement.Operation
    ...
    class Export implements IExport {
       ...
       */
      public static toObject(
        message: leancode.contracts.Export,
        options?: $protobuf.IConversionOptions,
      ): { [k: string]: any }

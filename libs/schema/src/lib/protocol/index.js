  ...
  leancode.contracts = (function () {
    ...
    contracts.ValueRef = (function () {
      ...
      ValueRef.decode = function decode(reader, length, error) {
        ...
        var end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.leancode.contracts.ValueRef()
      ...
      ValueRef.fromObject = function fromObject(object) {
        ...
        if (object["null"] != null) {
          if (typeof object["null"] !== "object") throw TypeError(".leancode.contracts.ValueRef.null: object expected")
          message["null"] = $root.leancode.contracts.ValueRef.Null.fromObject(object["null"])
        }
        if (object.number != null) {
          if (typeof object.number !== "object") throw TypeError(".leancode.contracts.ValueRef.number: object expected")
        ...
        if (object.string != null) {
          if (typeof object.string !== "object") throw TypeError(".leancode.contracts.ValueRef.string: object expected")
          message.string = $root.leancode.contracts.ValueRef.String.fromObject(object.string)
        }
        if (object.bool != null) {
          if (typeof object.bool !== "object") throw TypeError(".leancode.contracts.ValueRef.bool: object expected")
      ...
      ValueRef.Null = (function () {
        ...
        Null.decode = function decode(reader, length, error) {
          if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
          var end = length === undefined ? reader.len : reader.pos + length,
            message = new $root.leancode.contracts.ValueRef.Null()
          while (reader.pos < end) {
            var tag = reader.uint32()
            if (tag === error) break
            switch (tag >>> 3) {
      ...
      ValueRef.Number = (function () {
        ...
        Number.decode = function decode(reader, length, error) {
          if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
          var end = length === undefined ? reader.len : reader.pos + length,
            message = new $root.leancode.contracts.ValueRef.Number()
          while (reader.pos < end) {
            var tag = reader.uint32()
            if (tag === error) break
            switch (tag >>> 3) {
      ...
      ValueRef.FloatingPointNumber = (function () {
        ...
        FloatingPointNumber.decode = function decode(reader, length, error) {
          if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
          var end = length === undefined ? reader.len : reader.pos + length,
            message = new $root.leancode.contracts.ValueRef.FloatingPointNumber()
          while (reader.pos < end) {
            var tag = reader.uint32()
            if (tag === error) break
            switch (tag >>> 3) {
      ...
      ValueRef.String = (function () {
        ...
        String.decode = function decode(reader, length, error) {
          if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
          var end = length === undefined ? reader.len : reader.pos + length,
            message = new $root.leancode.contracts.ValueRef.String()
          while (reader.pos < end) {
            var tag = reader.uint32()
            if (tag === error) break
            switch (tag >>> 3) {
      ...
      ValueRef.Boolean = (function () {
        ...
        Boolean.decode = function decode(reader, length, error) {
          if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
          var end = length === undefined ? reader.len : reader.pos + length,
            message = new $root.leancode.contracts.ValueRef.Boolean()
          while (reader.pos < end) {
            var tag = reader.uint32()
            if (tag === error) break
            switch (tag >>> 3) {
    ...
    contracts.TypeRef = (function () {
      ...
      TypeRef.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
        var end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.leancode.contracts.TypeRef()
        while (reader.pos < end) {
          var tag = reader.uint32()
          if (tag === error) break
          switch (tag >>> 3) {
      ...
      TypeRef.fromObject = function fromObject(object) {
        ...
        if (object.known != null) {
          if (typeof object.known !== "object") throw TypeError(".leancode.contracts.TypeRef.known: object expected")
      ...
      TypeRef.toObject = function toObject(message, options) {
        ...
        if (message.nullable != null && message.hasOwnProperty("nullable")) object.nullable = message.nullable
        if (message.generic != null && message.hasOwnProperty("generic")) {
      ...
      TypeRef.Generic = (function () {
        ...
        Generic.decode = function decode(reader, length, error) {
          if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
          var end = length === undefined ? reader.len : reader.pos + length,
            message = new $root.leancode.contracts.TypeRef.Generic()
          while (reader.pos < end) {
            var tag = reader.uint32()
            if (tag === error) break
            switch (tag >>> 3) {
      ...
      TypeRef.Internal = (function () {
        ...
        Internal.decode = function decode(reader, length, error) {
          if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
          var end = length === undefined ? reader.len : reader.pos + length,
            message = new $root.leancode.contracts.TypeRef.Internal()
          while (reader.pos < end) {
            var tag = reader.uint32()
            if (tag === error) break
            switch (tag >>> 3) {
      ...
      TypeRef.Known = (function () {
        ...
        Known.decode = function decode(reader, length, error) {
          if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
          var end = length === undefined ? reader.len : reader.pos + length,
            message = new $root.leancode.contracts.TypeRef.Known()
          while (reader.pos < end) {
            var tag = reader.uint32()
            if (tag === error) break
            switch (tag >>> 3) {
    ...
    contracts.NotificationTypeRef = (function () {
      ...
      NotificationTypeRef.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
        var end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.leancode.contracts.NotificationTypeRef()
        while (reader.pos < end) {
          var tag = reader.uint32()
          if (tag === error) break
          switch (tag >>> 3) {
    ...
    contracts.GenericParameter = (function () {
      ...
      GenericParameter.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
        var end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.leancode.contracts.GenericParameter()
        while (reader.pos < end) {
          var tag = reader.uint32()
          if (tag === error) break
          switch (tag >>> 3) {
    ...
    contracts.AttributeArgument = (function () {
      ...
      AttributeArgument.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
        var end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.leancode.contracts.AttributeArgument()
        while (reader.pos < end) {
          var tag = reader.uint32()
          if (tag === error) break
          switch (tag >>> 3) {
      ...
      AttributeArgument.Positional = (function () {
        ...
        Positional.decode = function decode(reader, length, error) {
          if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
          var end = length === undefined ? reader.len : reader.pos + length,
            message = new $root.leancode.contracts.AttributeArgument.Positional()
          while (reader.pos < end) {
            var tag = reader.uint32()
            if (tag === error) break
            switch (tag >>> 3) {
      ...
      AttributeArgument.Named = (function () {
        ...
        Named.decode = function decode(reader, length, error) {
          if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
          var end = length === undefined ? reader.len : reader.pos + length,
            message = new $root.leancode.contracts.AttributeArgument.Named()
          while (reader.pos < end) {
            var tag = reader.uint32()
            if (tag === error) break
            switch (tag >>> 3) {
    ...
    contracts.AttributeRef = (function () {
      ...
      AttributeRef.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
        var end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.leancode.contracts.AttributeRef()
        while (reader.pos < end) {
          var tag = reader.uint32()
          if (tag === error) break
          switch (tag >>> 3) {
    ...
    contracts.PropertyRef = (function () {
      ...
      PropertyRef.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
        var end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.leancode.contracts.PropertyRef()
        while (reader.pos < end) {
          var tag = reader.uint32()
          if (tag === error) break
          switch (tag >>> 3) {
      ...
      PropertyRef.fromObject = function fromObject(object) {
        ...
        if (object.type != null) {
          if (typeof object.type !== "object") throw TypeError(".leancode.contracts.PropertyRef.type: object expected")
          message.type = $root.leancode.contracts.TypeRef.fromObject(object.type)
        }
        if (object.name != null) message.name = String(object.name)
      ...
      PropertyRef.toObject = function toObject(message, options) {
        ...
        if (message.comment != null && message.hasOwnProperty("comment")) object.comment = message.comment
        return object
      }
    ...
    contracts.ConstantRef = (function () {
      ...
      ConstantRef.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
        var end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.leancode.contracts.ConstantRef()
        while (reader.pos < end) {
          var tag = reader.uint32()
          if (tag === error) break
          switch (tag >>> 3) {
    ...
    contracts.EnumValue = (function () {
      ...
      EnumValue.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
        var end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.leancode.contracts.EnumValue()
        while (reader.pos < end) {
          var tag = reader.uint32()
          if (tag === error) break
          switch (tag >>> 3) {
    ...
    contracts.ErrorCode = (function () {
      ...
      ErrorCode.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
        var end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.leancode.contracts.ErrorCode()
        while (reader.pos < end) {
          var tag = reader.uint32()
          if (tag === error) break
          switch (tag >>> 3) {
      ...
      ErrorCode.fromObject = function fromObject(object) {
        ...
        if (object.group != null) {
          if (typeof object.group !== "object") throw TypeError(".leancode.contracts.ErrorCode.group: object expected")
      ...
      ErrorCode.Single = (function () {
        ...
        Single.decode = function decode(reader, length, error) {
          if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
          var end = length === undefined ? reader.len : reader.pos + length,
            message = new $root.leancode.contracts.ErrorCode.Single()
          while (reader.pos < end) {
            var tag = reader.uint32()
            if (tag === error) break
            switch (tag >>> 3) {
      ...
      ErrorCode.Group = (function () {
        ...
        Group.decode = function decode(reader, length, error) {
          if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
          var end = length === undefined ? reader.len : reader.pos + length,
            message = new $root.leancode.contracts.ErrorCode.Group()
          while (reader.pos < end) {
            var tag = reader.uint32()
            if (tag === error) break
            switch (tag >>> 3) {
    ...
    contracts.TypeDescriptor = (function () {
      ...
      TypeDescriptor.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
        var end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.leancode.contracts.TypeDescriptor()
        while (reader.pos < end) {
          var tag = reader.uint32()
          if (tag === error) break
          switch (tag >>> 3) {
    ...
    contracts.Statement = (function () {
      ...
      Statement.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
        var end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.leancode.contracts.Statement()
        while (reader.pos < end) {
          var tag = reader.uint32()
          if (tag === error) break
          switch (tag >>> 3) {
      ...
      Statement.fromObject = function fromObject(object) {
        ...
        if (object.dto != null) {
          if (typeof object.dto !== "object") throw TypeError(".leancode.contracts.Statement.dto: object expected")
          message.dto = $root.leancode.contracts.Statement.DTO.fromObject(object.dto)
        }
        if (object["enum"] != null) {
          if (typeof object["enum"] !== "object") throw TypeError(".leancode.contracts.Statement.enum: object expected")
          message["enum"] = $root.leancode.contracts.Statement.Enum.fromObject(object["enum"])
        }
        if (object.query != null) {
          if (typeof object.query !== "object") throw TypeError(".leancode.contracts.Statement.query: object expected")
        ...
        if (object.topic != null) {
          if (typeof object.topic !== "object") throw TypeError(".leancode.contracts.Statement.topic: object expected")
      ...
      Statement.DTO = (function () {
        ...
        DTO.decode = function decode(reader, length, error) {
          if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
          var end = length === undefined ? reader.len : reader.pos + length,
            message = new $root.leancode.contracts.Statement.DTO()
          while (reader.pos < end) {
            var tag = reader.uint32()
            if (tag === error) break
            switch (tag >>> 3) {
      ...
      Statement.Enum = (function () {
        ...
        Enum.decode = function decode(reader, length, error) {
          if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
          var end = length === undefined ? reader.len : reader.pos + length,
            message = new $root.leancode.contracts.Statement.Enum()
          while (reader.pos < end) {
            var tag = reader.uint32()
            if (tag === error) break
            switch (tag >>> 3) {
      ...
      Statement.Query = (function () {
        ...
        Query.decode = function decode(reader, length, error) {
          if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
          var end = length === undefined ? reader.len : reader.pos + length,
            message = new $root.leancode.contracts.Statement.Query()
          while (reader.pos < end) {
            var tag = reader.uint32()
            if (tag === error) break
            switch (tag >>> 3) {
      ...
      Statement.Command = (function () {
        ...
        Command.decode = function decode(reader, length, error) {
          if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
          var end = length === undefined ? reader.len : reader.pos + length,
            message = new $root.leancode.contracts.Statement.Command()
          while (reader.pos < end) {
            var tag = reader.uint32()
            if (tag === error) break
            switch (tag >>> 3) {
      ...
      Statement.Operation = (function () {
        ...
        Operation.decode = function decode(reader, length, error) {
          if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
          var end = length === undefined ? reader.len : reader.pos + length,
            message = new $root.leancode.contracts.Statement.Operation()
          while (reader.pos < end) {
            var tag = reader.uint32()
            if (tag === error) break
            switch (tag >>> 3) {
      ...
      Statement.Topic = (function () {
        ...
        Topic.decode = function decode(reader, length, error) {
          if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
          var end = length === undefined ? reader.len : reader.pos + length,
            message = new $root.leancode.contracts.Statement.Topic()
          while (reader.pos < end) {
            var tag = reader.uint32()
            if (tag === error) break
            switch (tag >>> 3) {
    ...
    contracts.Protocol = (function () {
      ...
      Protocol.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
        var end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.leancode.contracts.Protocol()
        while (reader.pos < end) {
          var tag = reader.uint32()
          if (tag === error) break
          switch (tag >>> 3) {
    ...
    contracts.Export = (function () {
      ...
      Export.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
        var end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.leancode.contracts.Export()
        while (reader.pos < end) {
          var tag = reader.uint32()
          if (tag === error) break
          switch (tag >>> 3) {
      ...
      Export.fromObject = function fromObject(object) {
        ...
        if (object.projectName != null) message.projectName = String(object.projectName)

    ...
    constructor({ attribute }: { attribute: leancode.contracts.IAttributeRef }) {
        ...
        this.namedArguments =
            attribute.argument
                ?.map(
                    argument =>
                        argument.named && new SchemaAttributeNamedArgument({ attributeNamedArgument: argument.named }),
                )
...
export class SchemaAttributeArgument {
    ...
    constructor({
        ...
        attributeArgument:
            | leancode.contracts.AttributeArgument.INamed
            | leancode.contracts.AttributeArgument.IPositional;
    }) {

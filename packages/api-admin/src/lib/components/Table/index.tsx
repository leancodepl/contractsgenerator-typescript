...
type GetAdminQuery<TCqrs extends Record<string, unknown>, TQueryKey extends string> =
...
type GetAdminQueryRecord<TCqrs extends Record<string, unknown>, TQueryKey extends string> =
